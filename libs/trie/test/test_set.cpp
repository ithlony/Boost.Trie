...
typedef typename tsci::iterator ti;
typedef typename tsci::const_iterator tci;
typedef typename tsci::reverse_iterator tri;
typedef typename tsci::const_reverse_iterator tcri;
